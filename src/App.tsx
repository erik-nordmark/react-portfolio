...
import { projectDevies, projectStena, projectVolvo, projectOmnipar, projectClaimscheck, projectSkim, projectMilestone, projectMouseophonic, projectErikNordmark, projectSwegon } from './assets/data/projects';
