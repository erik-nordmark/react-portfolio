...
import { projectDevies, projectStena, projectVolvo, projectOmnipar, projectClaimscheck, projectSkim, projectMilestone, projectMouseophonic, projectErikNordmark } from './assets/data/projects';
